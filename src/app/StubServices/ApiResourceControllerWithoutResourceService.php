...
class ApiResourceControllerWithoutResourceService extends BaseStubService implements StubServiceContract
{

    public function getStubPath(): string
    {
        return base_path('stubs/laravel-code/api-resource-controller-without-resource.stub');
    }
